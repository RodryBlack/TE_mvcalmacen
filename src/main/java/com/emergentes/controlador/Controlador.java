...
public class Controlador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ses.getAttribute("listaAl")==null){
            ArrayList<Almacen> listaux =new ArrayList<Almacen>();
            
            ses.setAttribute("listaAl",listaux);
        }
        
        ArrayList<Almacen> lista=(ArrayList<Almacen>)ses.getAttribute("listaAl");
        ...
        switch(option){
            ...
            case "eliminar":
                ...
                pos=buscarIndice(request,id);
                lista.remove(pos);
                ses.setAttribute("listaAl",lista);
